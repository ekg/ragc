...
struct RemoveSingletonsResult {
    size_t vec_new_len;
    size_t dup_new_len;
};
RemoveSingletonsResult ragc_remove_non_singletons_with_duplicates(
    uint64_t* vec_ptr, size_t vec_len, size_t vec_capacity,
    uint64_t* dup_ptr, size_t dup_len, size_t dup_capacity,
    size_t virtual_begin);
